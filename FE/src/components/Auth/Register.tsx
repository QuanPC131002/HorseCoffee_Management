        ...
        <div>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Đăng Ký</h2>
                </div>

                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" method="POST" onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            <label className="block text-sm/6 font-medium text-gray-900">Tên</label>
                            <div className="mt-2">
                                <input type="text"
                                 {...register('name', {
                        ...
                        <div>
                            <label className="block text-sm/6 font-medium text-gray-900">Điện thoại</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-900">Quyền</label>
                            <div className="mt-2">
                            <Controller
                                name="role"
                                control={control} 
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                        Đã là thành viên? <Link to="/auth" className="font-semibold text-indigo-600 hover:text-indigo-500">Đăng nhập</Link>
                    </p>
                </div>
            </div>
        </div>
