import { faBars, faFolder, faHouse, faRightFromBracket, faSearch, faTrash, faUser } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="w-full h-screen grid grid-cols-[10%,1fr]">
      ...
      <div className="mt-10 mb-10">
        <div className="p-4 text-center my-10">
            <Link to='/order'><FontAwesomeIcon icon={faHouse} className='h-[30px]'/></Link>
          </div>
          <div className="p-4 text-center my-10">
